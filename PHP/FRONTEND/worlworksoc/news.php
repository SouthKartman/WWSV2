<?php 
    ...
    if (isset($_POST['go_user_save'])){
        ...
        echo("<script>document.location.href  = '/worlworksoc/?news='</script>");
    }
    ...
    if (isset($_POST['postinuserprofile'])){
        ...
        if (trim($_POST['message']) != ''){
            ...
            echo("<script>document.location.href='/worlworksoc/?news=&id=".$user['id']."';</script>");
        }
    }
  ...
  //   if (isset($_POST['postinuserprofileproject'])){
                        
  //     if (trim($_POST['info_card']) != ''){
  //         $images = array();
  //         for ($i=0; $i < 4; $i++) {
  //             if (trim($_POST[(string)('i'.$i)]) != '') 
  //                 array_push($images, trim($_POST[(string)('i'.$i)]));
  ...
  //         mysqli_query($connections, "INSERT INTO `projects`( `images_json`, `userid`, `fromuser`,'title_card','info_card','link_card') VALUES ('{$_POST['message']}','{$images_json}','{$user['id']}','{$_SESSION['user']['id']}')");
  //         $id = mysqli_insert_id($connections);
  //         // $posts = json_decode($user['posts_json']);
  //         // array_push($posts, $id);
...
<div class="home_container" x-data="{ home_rightSide: false, home_leftSide: false }">
    ...
    <div class="home_main">
      ...
      <div class="home_main-container">
        ...
        <div class="home_timeline" style="padding:0px; z-index: 3;">
          ...
          <div class="home_timeline-right">
            <form action="#" method="POST">
                ...
                <div class="home_status-main">
                    ...
                    <textarea class="home_status-textarea" name="message" placeholder="Write something to <?php echo($user['name']);?>"  minlength="1"></textarea>
                </div>
...
<div class="home_album home_box">
              <div class="home_status-main">
                <div class="home_status-img" style="background-image: url(<?php echo($formuserinfo->avatar);?>);background-repeat: no-repeat;background-size: cover;"></div>
                <div class="home_album-detail">
                  <div class="home_album-title"><strong><a href="?home=&id=<?php echo $fromuser['id']; ?>" target="_blank"> <?php echo($fromuser['name']); ?></a></strong>
            ...
            echo date('H:i:s d/m/Y', $timestamp); ?>
              ...
              <div class="home_album-content"><div class="myarticle"><p><?php echo($item['message']); ?></p></div>
                <div class="home_album-photos">
                <div class="inner">
      <div class="photo-list">
                    <?php 
                        for ($j=0; $j < count($images); $j++) { ?>
                       <a class="zoom-gallery" href="<?php echo($images[$j]);?>" target_="_blank"> <img src="<?php echo($images[$j]);?>"
                      width="49%"
                      height="100%"
                      alt=""></a>
                        <?php
...
<?php } ?>
      ...
      <div class="none-global" style="width:100%; height:100px"></div>
    </div>
    ...
    ?>
        ...
        <div class="none-global" style="width:100%; height:165px"></div>
    </div>
