        ...
        <div class="home_profile">
          <div class="home_profile-avatar">
            ...
            <div class="home_profile-img" style="background-image: url(<?php echo($info->avatar) ?>);background-repeat: no-repeat;background-size: cover;"></div>
                ...
                <div class="home_profile-status-user"><p style="font-size: 15px; margin: buttom 10px;">Статус: <?php if ($info->born == "") echo('Не указано');else echo($info->born); ?></p></div>
          ...
          <div class="home_timeline-right">
            <form action="#" method="POST">
                ...
                <div class="home_status-main">
                    ...
                    <textarea class="home_status-textarea" name="message" placeholder="Write something to <?php echo($user['name']);?>"  minlength="20"></textarea>
                </div>
...
<div class="home_album home_box">
              ...
              <div class="home_album-content"><pre><?php echo '<div class="myarticle">'.$post['message'].'</div>'; ?></pre>
                <div class="home_album-photos">
                <?php 
                        for ($j=0; $j < count($images); $j++) { ?>
                       <a  class="home_album-photo"  href="<?php echo($images[$j]);?>" target_="_blank"> <img src="<?php echo($images[$j]);?>"></a>
                        <?php
                        }
                    ?>
...
<?php } ?>
    ...
    <div class="home_right-side" :class="{ 'active': home_rightSide }">
      <div class="home_account">
        <button class="home_account-button">
          <svg stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="home_css-i6dzq1" viewBox="0 0 24 24">
        ...
        <span class="home_account-user">Quan Ha
          <img src="https://images.genius.com/2326b69829d58232a2521f09333da1b3.1000x1000x1.jpg" alt="" class="home_account-profile" alt="">
          <span>▼</span>
        </span>
      </div>
      <div class="home_side-wrapper home_stories">
        <div class="home_side-title">STORIES</div>
        <div class="home_user">
          <img src="https://pbs.twimg.com/profile_images/1102351320567164931/ZCkJgJIH.png" alt="" class="home_user-img">
          <div class="home_username">Lisandro Matos
            <div class="home_album-date">12 hours ago</div>
          </div>
        </div>
        <div class="home_user">
          <img src="https://pbs.twimg.com/profile_images/1153966095444992000/1lpIyHaQ.jpg" alt="" class="home_user-img">
          <div class="home_username">Gvozden Boskovsky
            <div class="home_album-date">29 minutes ago</div>
          </div>
        </div>
        <div class="home_user">
          <img src="https://images.unsplash.com/photo-1565464027194-7957a2295fb7?ixlib=rb-1.2.1&auto=format&fit=crop&w=3500&q=80" alt="" class="home_user-img">
          <div class="home_username">Hnek Fortuin
            <div class="home_album-date">3 hours ago</div>
          </div>
        </div>
        <div class="home_user">
          <img src="https://images.unsplash.com/photo-1527980965255-d3b416303d12?ixlib=rb-1.2.1&auto=format&fit=crop&w=1400&q=80" alt="" class="home_user-img">
          <div class="home_username">Lubomir Dvorak
            <div class="home_album-date">18 hours ago</div>
          </div>
        </div>
      </div>
...
<div>
    <div id="editwindow">
        ...
        <form action="#" method="POST" style="margin-left:5%;">    
                ...
                <input  id="avatarurl" style="margin-top:1vw;" type="url"  require placeholder="Ссылка на аватар" name="avatar" oninput="if ($('#avatarurl').val().trim() ==''){ $('#avatarinput').attr('src','img/avatar.jpg'); return true; } $('#avatarinput').attr('src',$('#avatarurl').val()); " value="<?php echo($info->avatar);?>"><br>
                ...
                <input style="margin-top:1vw;" type="text" placeholder="Место жительства" name="mest_jit" value="<?php echo($info->location);?>"><br>
                <input style="margin-top:1vw;" type="text" placeholder="Родился" name="rodil" value="<?php echo($info->born);?>"><br>
                <input style="margin-top:1vw;" type="text" placeholder="Работает" name="rab" value="<?php echo($info->job);?>"><br>
                <input style="margin-top:1vw;" type="text" placeholder="Учился/Учится" name="uch" value="<?php echo($info->study);?>"><br>
                <input style="margin-top:1vw;" type="text" placeholder="Семейное положение" name="polog" value="<?php echo($info->type);?>"><br>
                <input style="margin-top:1vw;" type="text" placeholder="Увлечение" name="evlech" value="<?php echo($info->hobby);?>"><br>
                <input style="margin-top:1vw;" type="submit" value="Сохранить" style="width:90%;" name="go_user_save">
        </form>
